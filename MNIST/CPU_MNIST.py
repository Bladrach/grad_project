...
torch.save(networks, 'CPU_MNIST.pt')

"""
# Load neural networks from the file
networks = torch.load('CPU_MNIST.pt')
"""
...
plt.ylabel('Accuracy (%)', fontsize = 16) 
# Plot title 
plt.title('Each Accuracy for 3 NETWORKS Each Class Comparison (CPU = i7-4720HQ)', fontsize = 18) 
# Add legend  
plt.legend(loc = 1)

plt.figure(1).set_size_inches(25,15)
plt.savefig('CPU_MNIST_RESULTS_for_10_epochs.png', bbox_inches='tight')
